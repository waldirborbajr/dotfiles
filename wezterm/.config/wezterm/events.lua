...
-- This file contains event handlers and utility functions for WezTerm
...
function readjust_font_size(window, pane)
  ...
  local initial_font_size = 14 -- Starting font size for adjustment
  config_overrides.font_size = initial_font_size

  -- Algorithm constraints to prevent infinite loops
  local max_iterations = 5      -- Maximum number of adjustment attempts
  local iteration_count = 0     -- Current iteration counter
  local tolerance = 3           -- Acceptable pixel difference (3px tolerance)
